...
<nav class="sticky top-0 z-40 border-b border-[#DFD5C4] bg-[#FAF7F2]">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-1 text-[11px] tracking-[0.15em] uppercase text-[#6B6154]">
            <a href="<?= $base_path ?>resep/index.php" class="no-underline px-4 py-2 rounded font-semibold transition-all duration-300 ease-out <?= $active_page === 'resep' ? 'text-white bg-[#A3492D] shadow-[0_4px_10px_rgba(163,73,45,0.35)]' : 'text-black hover:text-white hover:bg-[#A3492D] hover:shadow-[0_4px_10px_rgba(163,73,45,0.35)] hover:-translate-y-0.5' ?>">Resep</a>
            <a href="<?= $base_path ?>rekomendasi.php" class="no-underline px-4 py-2 rounded font-semibold transition-all duration-300 ease-out <?= $active_page === 'rekomendasi' ? 'text-white bg-[#A3492D] shadow-[0_4px_10px_rgba(163,73,45,0.35)]' : 'text-black hover:text-white hover:bg-[#A3492D] hover:shadow-[0_4px_10px_rgba(163,73,45,0.35)] hover:-translate-y-0.5' ?>">Rekomendasi</a>
            <a href="<?= $base_path ?>resep_by_bahan.php" class="no-underline px-4 py-2 rounded font-semibold transition-all duration-300 ease-out <?= $active_page === 'cari_bahan' ? 'text-white bg-[#A3492D] shadow-[0_4px_10px_rgba(163,73,45,0.35)]' : 'text-black hover:text-white hover:bg-[#A3492D] hover:shadow-[0_4px_10px_rgba(163,73,45,0.35)] hover:-translate-y-0.5' ?>">Cari Bahan</a>
            <a href="<?= $base_path ?>pustaka_gizi.php" class="no-underline px-4 py-2 rounded font-semibold transition-all duration-300 ease-out <?= $active_page === 'pustaka_gizi' ? 'text-white bg-[#A3492D] shadow-[0_4px_10px_rgba(163,73,45,0.35)]' : 'text-black hover:text-white hover:bg-[#A3492D] hover:shadow-[0_4px_10px_rgba(163,73,45,0.35)] hover:-translate-y-0.5' ?>">Pustaka Gizi</a>
            <div class="relative">
