...
<nav class="sticky top-0 z-40 border-b border-[#DFD5C4] bg-[#FAF7F2]">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-6 text-[11px] tracking-[0.15em] uppercase text-[#6B6154]">
            <a href="<?= $base_path ?>resep/index.php" class="no-underline <?= $active_page === 'resep' ? 'text-[#A3492D]' : 'hover:text-[#2C2620]' ?>">Resep</a>
            <a href="<?= $base_path ?>rekomendasi.php" class="no-underline <?= $active_page === 'rekomendasi' ? 'text-[#A3492D]' : 'hover:text-[#2C2620]' ?>">Rekomendasi</a>
            <a href="<?= $base_path ?>resep_by_bahan.php" class="no-underline <?= $active_page === 'cari_bahan' ? 'text-[#A3492D]' : 'hover:text-[#2C2620]' ?>">Cari Bahan</a>
            <a href="<?= $base_path ?>pustaka_gizi.php" class="no-underline <?= $active_page === 'pustaka_gizi' ? 'text-[#A3492D]' : 'hover:text-[#2C2620]' ?>">Pustaka Gizi</a>
            <div class="relative">
