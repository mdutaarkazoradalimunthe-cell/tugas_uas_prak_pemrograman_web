...
<nav class="sticky top-0 z-40 border-b border-[#DFD5C4] bg-[#FAF7F2]">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <a href="index.php" class="block"><img src="../assets/images/logo.png" alt="Rasa dan Gizi" class="h-14 w-auto"></a>
        <div class="flex items-center gap-6 text-[11px] tracking-[0.15em] uppercase text-[#6B6154]">
            <a href="index.php" class="text-[#A3492D] no-underline">Resep</a>
...
<div class="max-w-4xl mx-auto px-6 py-8">
    <div class="flex items-start gap-6 mb-8">
        <div class="flex-1">
            <span class="text-[#A3492D] text-[12px] tracking-[0.15em] uppercase block mb-1">Resep Baru</span>
            <h1 class="font-serif text-3xl text-[#2C2620] font-normal">Tambah Resep Baru</h1>
        </div>
    ...
    <form method="POST" action="" class="bg-white p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] rounded-[2px]">
        ...
        <div class="flex gap-3">
            <button type="submit" class="py-2.5 px-6 border border-[#A3492D] bg-[#A3492D] text-white text-[13px] tracking-[0.1em] uppercase hover:bg-[#8B3D25] hover:-translate-y-0.5 shadow-[0_6px_14px_rgba(163,73,45,0.35)] hover:shadow-[0_8px_22px_rgba(163,73,45,0.45)] transition-all">Simpan Resep</button>
            <a href="index.php" class="py-2.5 px-6 border border-[#D1C4B0] bg-white text-[13px] tracking-[0.1em] uppercase text-[#4A4438] hover:bg-[#F5F0E8] hover:-translate-y-0.5 shadow-[0_4px_10px_rgba(0,0,0,0.14)] hover:shadow-[0_7px_16px_rgba(0,0,0,0.2)] transition-all no-underline">Batal</a>
        </div>
    </form>
</div>
