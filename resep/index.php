...
<nav class="sticky top-0 z-40 border-b border-[#DFD5C4] bg-[#FAF7F2]">    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">        <a href="index.php" class="block">
<img src="../assets/images/logo.png" alt="Rasa dan Gizi" class="h-14 w-auto">
</a>        <div class="flex items-center gap-6 text-[11px] tracking-[0.15em] uppercase text-[#6B6154]">            <a href="index.php" class="text-[#A3492D] no-underline">Resep</a>            <a href="../rekomendasi.php" class="hover:text-[#2C2620] no-underline">Rekomendasi</a>            <a href="../resep_by_bahan.php" class="hover:text-[#2C2620] no-underline">Cari Bahan</a>            <a href="../pustaka_gizi.php" class="hover:text-[#2C2620] no-underline">Pustaka Gizi</a>            <div class="relative">                <span class="text-[#6B6154] cursor-pointer user-dropdown-trigger">Halo, <?= htmlspecialchars($_SESSION['nama']) ?> <span class="text-[10px] ml-0.5">▾</span>
</span>                <div class="user-dropdown-menu absolute right-0 top-full mt-1 w-36 bg-[#FAF7F2] border border-[#D1C4B0] hidden z-50">                    <a href="../profil.php" class="block px-4 py-2.5 text-[13px] text-[#2C2620] no-underline hover:bg-[#E4DBC8] transition-colors">Profil</a>                    <a href="../logout.php" class="block px-4 py-2.5 text-[13px] text-[#A3492D] no-underline hover:bg-[#E4DBC8] transition-colors border-t border-[#D1C4B0]">Keluar</a>                </div>            </div>        </div>    </div>
</nav>
<div class="max-w-6xl mx-auto px-6 py-8">    <div class="flex items-start justify-between mb-10">        <div>            <span class="text-[#A3492D] text-[12px] tracking-[0.15em] uppercase block mb-1">Dashboard</span>            <h1 class="font-serif text-3xl text-[#2C2620] font-normal">Resep Saya</h1>        </div>        <a href="tambah.php" class="py-2.5 px-5 border border-[#A3492D] bg-[#A3492D] text-white text-[13px] tracking-[0.1em] uppercase hover:bg-[#8B3D25] hover:-translate-y-0.5 shadow-[0_6px_14px_rgba(163,73,45,0.35)] hover:shadow-[0_8px_22px_rgba(163,73,45,0.45)] transition-all no-underline inline-block">            + Tambah Resep        </a>    </div>    <?php if (empty($resep_list)): ?>        <div class="bg-[#E4DBC8] p-16 text-center">            <p class="text-[#4A4438] text-base mb-5">Belum ada resep. Yuk buat resep pertama kamu!</p>            <a href="tambah.php" class="py-2.5 px-5 border border-[#A3492D] bg-[#A3492D] text-white text-[13px] tracking-[0.1em] uppercase hover:bg-[#8B3D25] hover:-translate-y-0.5 shadow-[0_6px_14px_rgba(163,73,45,0.35)] hover:shadow-[0_8px_22px_rgba(163,73,45,0.45)] transition-all no-underline inline-block">Buat Resep Sekarang</a>        </div>    <?php else: ?>        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">            <?php foreach ($resep_list as $resep):                 $gizi = hitung_gizi_resep($resep['id']);
