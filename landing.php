...
<nav class="sticky top-0 z-40 bg-[#FAF7F2] max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
    <a href="landing.php" class="block"><img src="assets/images/logo.png" alt="Rasa dan Gizi" class="h-16 w-auto"></a>
    <div class="flex items-center gap-8 text-[12px] tracking-[0.15em] uppercase text-[#4A4438]">
...
<main class="max-w-6xl mx-auto px-6">
    ...
    <h1 class="font-serif text-4xl md:text-5xl leading-tight text-[#2C2620] font-normal mb-8 max-w-3xl">
        Jelajahi Dunia Rasa<br>dan Ilmu Gizi
    </h1>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 mb-16">
        <div class="md:col-span-2 relative">
            <img src="assets/images/hero.jpg" alt="Hidangan sehat" class="w-full h-[420px] md:h-[520px] object-cover" style="object-position: 50% 30%;">
            <div class="absolute bottom-4 left-4 bg-[#FAF7F2]/90 border border-[#DFD5C4] px-5 py-4 max-w-[260px]">
                <span class="text-[#A3492D] text-[12px] tracking-[0.15em] uppercase block mb-1">Bahan Pangan</span>
                <p class="text-sm text-[#2C2620] leading-snug">
